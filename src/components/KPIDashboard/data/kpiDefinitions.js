// src/components/KPIDashboard/data/kpiDefinitions.js
...
export const KPI_CLIENT_RETENTION = {
  ...
  successFactors: [
    ...
    "Monitor responsiveness, consistency and proactiveness of all communication with Clients (draft)",
    "Maximize offering of extra services for properties in line with budgets and as needed (draft)",
    "Utilize internal systems to capture accurate status of issues so items can be addressed efficiently and effectively"
  ]
};

export const KPI_VISIT_NOTE_CREATION = {
...
export const KPI_DIRECT_LABOR_MAINTENANCE = {
  ...
  successFactors: [
    ...
    "Identify opportunities to maximize crew efficiency and productivity",
...
export const KPI_LV_MAINTENANCE_GROWTH = {
  ...
  successFactors: [
    ...
    "Nurture existing client relationships to become our client's preferred service provider"
  ]
};
